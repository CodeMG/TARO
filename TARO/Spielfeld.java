...
public class Spielfeld extends JPanel  {
    ...
    public Spielfeld(){
        ...
        spieler.setText(new GUITextFeld("Willkommen zur Demo unseres Projektes.Die Demo zeigt nur den Entwicklungsstand und beinhaltet noch keine Story."+
        " Du kannst dich mit "+Steuerung.getObenTastenText()+Steuerung.getLinksTastenText()+Steuerung.getUntenTastenText()+Steuerung.getRechtsTastenText()+ " bewegen. Der Spieler hat am Anfang zwei Items: Einen Speer den du mit "+Steuerung.getAngriffTastenText()+" benutzt und eine Steinschleuder,"+
        " die mit "+Steuerung.getBenutzenTastenText()+" abgefeuert werden kann. Mit "+Steuerung.getPauseTastenText()+" pausierst du das Spiel. Viel Spaß mit der Demo."));
