...
public class Bilder{
    ...
    baum,baummaske, huette, huettenmaske,schwerter[],schwerterMaske[],schwerticon, stein,steinMaske, schleudericon, npc[], npcmaske;
    ...
    public Bilder(){
        ...
        schwerticon = bildHinzufuegenAusPfad("texturen//Bilder//Sonstiges//schwerticon.png");
        
        schleudericon = bildHinzufuegenAusPfad("texturen//Bilder//Sonstiges//schleudericon.png");
    ...
    public static BufferedImage getSchwerticon(){
        return schwerticon;
    }
    
    public static BufferedImage getSchleudericon(){
        return schleudericon;
    }
